...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     user experience. -->
     <!-- page script -->
@if (\Request::is('admins') or \Request::is('roles') or \Request::is('categories') or \Request::is('menu') or \Request::is('customers') or \Request::is('leads') or Route::currentRouteName()=='leads.show' or \Request::is('recordings') or \Request::is('sellers') or \Request::is('products') or \Request::is('orders') or \Request::is('attributes') or \Request::is('memberships') or \Request::is('membershipsreports') or  Route::currentRouteName()=='seller.pending' or Route::currentRouteName()=='order.messages' or \Request::is('support'))  
